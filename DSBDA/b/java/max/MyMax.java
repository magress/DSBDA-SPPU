	...
	public static class MaxTemperatureMapper extends
		...
		public void map(LongWritable arg0, Text Value, Context context)
			...
			if (!(line.length() == 0)) {				
				...
				//maximum temperature				
				float temp_Max = Float.parseFloat(line.substring(45, 51).trim());			

				//if maximum temperature is greater than 35 , its a hot day				
				if (temp_Max < 100 && temp_Max > max_temp) 
					context.write(new Text("Hottest Day of " + year + " is: "),new FloatWritable(temp_Max));
			}
		}
	}
